...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Bruv', 0.4], //From 20% to 39%
		['Sucks', 0.5], //From 40% to 49%
		['Amogus', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Cool', 0.7], //69%
		['Very cool', 0.8], //From 70% to 79%
		['Yo!', 0.9], //From 80% to 89%
		['Chad', 1], //From 90% to 99%
		['Que pro', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
